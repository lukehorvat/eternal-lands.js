...
/**
 * See: https://github.com/raduprv/Eternal-Lands/blob/968f90742b68659b201ea8c0790be0e60267b750/client_serv.h#L870-L963
 */
export enum StatType {
  ATTRIBUTE_PHYSIQUE_CURRENT = 0,
  ATTRIBUTE_PHYSIQUE_BASE = 1,
  ATTRIBUTE_COORDINATION_CURRENT = 2,
  ATTRIBUTE_COORDINATION_BASE = 3,
  ATTRIBUTE_REASONING_CURRENT = 4,
  ATTRIBUTE_REASONING_BASE = 5,
  ATTRIBUTE_WILL_CURRENT = 6,
  ATTRIBUTE_WILL_BASE = 7,
  ATTRIBUTE_INSTINCT_CURRENT = 8,
  ATTRIBUTE_INSTINCT_BASE = 9,
  ATTRIBUTE_VITALITY_CURRENT = 10,
  ATTRIBUTE_VITALITY_BASE = 11,
  NEXUS_HUMAN_CURRENT = 12,
  NEXUS_HUMAN_BASE = 13,
  NEXUS_ANIMAL_CURRENT = 14,
  NEXUS_ANIMAL_BASE = 15,
  NEXUS_VEGETAL_CURRENT = 16,
  NEXUS_VEGETAL_BASE = 17,
  NEXUS_INORGANIC_CURRENT = 18,
  NEXUS_INORGANIC_BASE = 19,
  NEXUS_ARTIFICIAL_CURRENT = 20,
  NEXUS_ARTIFICIAL_BASE = 21,
  NEXUS_MAGIC_CURRENT = 22,
  NEXUS_MAGIC_BASE = 23,
  SKILL_MANUFACTURING_CURRENT = 24,
  SKILL_MANUFACTURING_BASE = 25,
  SKILL_HARVESTING_CURRENT = 26,
  SKILL_HARVESTING_BASE = 27,
  SKILL_ALCHEMY_CURRENT = 28,
  SKILL_ALCHEMY_BASE = 29,
  SKILL_OVERALL_CURRENT = 30,
  SKILL_OVERALL_BASE = 31,
  SKILL_DEFENSE_CURRENT = 32,
  SKILL_DEFENSE_BASE = 33,
  SKILL_ATTACK_CURRENT = 34,
  SKILL_ATTACK_BASE = 35,
  SKILL_MAGIC_CURRENT = 36,
  SKILL_MAGIC_BASE = 37,
  SKILL_POTION_CURRENT = 38,
  SKILL_POTION_BASE = 39,
  CARRY_CAPACITY_CURRENT = 40,
  CARRY_CAPACITY_BASE = 41,
  MATERIAL_POINTS_CURRENT = 42,
  MATERIAL_POINTS_BASE = 43,
  ETHEREAL_POINTS_CURRENT = 44,
  ETHEREAL_POINTS_BASE = 45,
  FOOD_LEVEL = 46,
  RESEARCHING = 47,
  EXP_MANUFACTURING = 49,
  EXP_MANUFACTURING_NEXT_LEVEL = 50,
  EXP_HARVESTING = 51,
  EXP_HARVESTING_NEXT_LEVEL = 52,
  EXP_ALCHEMY = 53,
  EXP_ALCHEMY_NEXT_LEVEL = 54,
  EXP_OVERALL = 55,
  EXP_OVERALL_NEXT_LEVEL = 56,
  EXP_DEFENSE = 57,
  EXP_DEFENSE_NEXT_LEVEL = 58,
  EXP_ATTACK = 59,
  EXP_ATTACK_NEXT_LEVEL = 60,
  EXP_MAGIC = 61,
  EXP_MAGIC_NEXT_LEVEL = 62,
  EXP_POTION = 63,
  EXP_POTION_NEXT_LEVEL = 64,
  RESEARCH_COMPLETED = 65,
  RESEARCH_TOTAL = 66,
  EXP_SUMMONING = 67,
  EXP_SUMMONING_NEXT_LEVEL = 68,
  SKILL_SUMMONING_CURRENT = 69,
  SKILL_SUMMONING_BASE = 70,
  EXP_CRAFTING = 71,
  EXP_CRAFTING_NEXT_LEVEL = 72,
  SKILL_CRAFTING_CURRENT = 73,
  SKILL_CRAFTING_BASE = 74,
  EXP_ENGINEERING = 75,
  EXP_ENGINEERING_NEXT_LEVEL = 76,
  SKILL_ENGINEERING_CURRENT = 77,
  SKILL_ENGINEERING_BASE = 78,
  EXP_RANGING = 79,
  EXP_RANGING_NEXT_LEVEL = 80,
  SKILL_RANGING_CURRENT = 81,
  SKILL_RANGING_BASE = 82,
  EXP_TAILORING = 83,
  EXP_TAILORING_NEXT_LEVEL = 84,
  SKILL_TAILORING_CURRENT = 85,
  SKILL_TAILORING_BASE = 86,
  ACTION_POINTS_CURRENT = 87,
